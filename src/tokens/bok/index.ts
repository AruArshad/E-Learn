...
const TOKEN_NAME = "BOOK";
const TOKEN_SYMBOL = "BOK";
const TOKEN_DESCRIPTION = "A token for learners";
const TOKEN_IMAGE_NAME = "book.png";
const TOKEN_IMAGE_PATH = `src/tokens/bok/assets/${TOKEN_IMAGE_NAME}`;
